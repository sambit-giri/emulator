...
from emulator import Fit_RandomForest
...
n_samples1  = 10
range_param = {'0': [0,5]}
mod1 = Fit_RandomForest(func1, n_samples1, range_param=range_param, sampling_method='lh-maximin')
mod1.model_func()
...
n_samples2  = 10
range_param = {'0': [0,5]}
mod2 = Fit_RandomForest(func2, n_samples2, range_param=range_param, sampling_method='lh-maximin')
mod2.model_func()
...
mod3 = Fit_RandomForest(func3, n_samples3, range_param=range_param, sampling_method='lh-maximin')
mod3.model_func()
